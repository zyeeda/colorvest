...
(function() {
  ...
  define(['underscore', 'jquery', 'bootstrap', 'coala/features/dialog/__layouts__/dialog', 'coala/features/dialog/__views__/dialog-title', 'coala/features/dialog/__views__/dialog-buttons', 'text!coala/features/dialog/__templates__/dialog-title.html', 'text!coala/features/dialog/__templates__/dialog.html', 'text!coala/features/dialog/__templates__/dialog-buttons.html'], function(_, $) {
    return {
      views: [
        {
          name: 'dialog-title',
