...
(function() {
  ...
  define(['underscore', 'coala/coala', 'coala/components/callbacks/grid', 'order!coala/vendors/jquery/jqgrid/i18n/grid.locale-cn', 'order!coala/vendors/jquery/jqgrid/jquery.jqGrid.src'], function(_, coala, cbGrid) {
