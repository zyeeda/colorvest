...
define(['jquery', 'underscore', 'coala/coala', 'coala/core/application', 'coala/core/browser', 'coala/core/component-handler', 'coala/core/config', 'coala/vendors/jquery/pnotify/jquery.pnotify', 'coala/scaffold/scaffold', 'coala/features/home'], function($, _, coala, Application, detectBrowser, ComponentHandler, config) {
  return function(options) {
    var application, modifyFeatureContainerDeferred, openedFeatures, stack_bar_top;
    if (options == null) {
      options = {};
    }
